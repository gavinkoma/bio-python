...
if __name__=="__main__":
    ...
    print('Module: ', sys.argv[1]) #this basically takes everything in commandline
    #and stores it as an argument list; the arg at 0 is going to be the file name
    #the index then after all etc.etc.
    ...
    # from threadplay file; adjusted so if the arg is thread then task variabel is equal to thread_
    # if it is then we run the jobs in threadding way
    if sys.argv[1] == 'thread':
        ...
        if sys.argv[2] == 'afterall': #this is 2nd argument in the command line
